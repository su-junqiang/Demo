package com.test.rabbitMQ.remoting;

import com.rabbitmq.client.*;
import com.test.rabbitMQ.ExchangeType;
import com.test.rabbitMQ.InvalidRoutingKeyException;
        ...
        try {
            ...
            for (int i = 1; i <= poolsize; i++) {
                try {
                    ...
                    log.info(String
                                     .format("Starting rpc service %d on exchange [%s(%s)] - queue [%s] - routingKey [%s]",
